<?php
$url = "https://prtg.lumiad.com/api/table.json?content=values&output=json&columns=datetime,value_,coverage&id=1005&noraw=1&usecaption=true&username=Pim%20Bohm&password=P1mP1mP1mP1m";
